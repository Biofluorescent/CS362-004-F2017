 ...
 * Tanner Quesenberry
 * Fall 2017 CS362
 * Random test file for the Adventurer card.
 */
...
/*
 * This function verifies that the Adventurer card altered the players
 * deck card count and hand count correctly after the adventurer card
